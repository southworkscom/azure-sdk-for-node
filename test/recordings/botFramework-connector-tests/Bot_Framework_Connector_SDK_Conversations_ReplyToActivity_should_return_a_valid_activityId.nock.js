...
.post('/v3/conversations', '*')
  ...
  date: 'Thu, 04 Jan 2018 20:56:47 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://slack.botframework.com:443')
  .filteringRequestBody(function (path) { return '*';})
.post('/v3/conversations/B21S8SG7J%3AT03CWQ0QB%3AD8K7XGZU3/activities/1515099408.000428', '*')
  .reply(200, "{\r\n  \"id\": \"1515099409.000439\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '33',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  ...
  'x-powered-by': 'ASP.NET',
  'strict-transport-security': 'max-age=31536000',
  date: 'Thu, 04 Jan 2018 20:56:49 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
